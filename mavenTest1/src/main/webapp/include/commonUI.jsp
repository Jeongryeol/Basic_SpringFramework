<%	
	//String Project_Root = request.getContextPath();
	String Project_Root = "/mvc/resources";//Maven이 바라볼 수 있도록 경로를 수정해줌...
%>
...
<script type="text/javascript" src="<%=Project_Root %>/js/commons.js"></script>
...
<script type="text/javascript" src="<%=Project_Root %>/js/jquery.cookie.js"></script>