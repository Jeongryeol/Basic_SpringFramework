...
<%-- 		$("#b_title").textbox('setValue','<%=rb_title%>');
    ...
    <table align="center">
	    	<tr>
	    	<td>제목</td>
	    	<td><input id="b_title" value="<%=rb_title%>" name="b_title" data-options="width:'250px'" class="easyui-textbox" readonly></td>
	    	</tr>
	    	<tr>
	    	<td>작성자</td>
	    	<td><input id="b_name" value="<%=rb_name%>" name="b_name" class="easyui-textbox" readonly></td>
	    	</tr>
	    	<tr>
	    	<td>내용</td>
	    	<td><input id="b_content" value="<%=rb_content%>" name="b_content" data-options="multiline:'true', width:'350px', height:'90px'" class="easyui-textbox" readonly></td>
	    	</tr>
	    	<tr>
	    	<td>비밀번호</td>
	    	<td><input id="b_pwd" value="<%=rb_pwd%>" name="b_pwd" class="easyui-passwordbox" readonly></td>
	    	</tr>	    	
	   </table>
	    	</form>
	    <table align="center">
	    	...
	    	<td>
				...
				<a href="javascript:deleteForm()" class="easyui-linkbutton">삭제</a>
