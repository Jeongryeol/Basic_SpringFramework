...
<html>
<head>
<title>Bone - Creative Agency Portfolio Template</title>
...
<body>
	...
	<div class="nav-container">
		<ul class="nav">
			...
			<ul class="dropdown">
					<li><a href="pages/portfolio-3-col.html">3 Columns - Masonry</a></li>
					<li><a href="pages/portfolio-no-spacing.html">3 Columns - No Spacing</a></li>
					<li><a href="pages/portfolio-lightbox.html">Lightbox Portfolio</a></li>
					<li><a href="pages/portfolio-single.html">Single Item #1</a></li>
					<li><a href="pages/portfolio-single-2.html">Single Item #2</a></li>
				</ul></li>
			<li><a href="#">Pages </a>
			<ul class="dropdown">
	...
	<div id="wrapper" class="container-fluid smooth-transition">
		...
		<header>
			<div class="container">
				<!-- Branding-->
				<a href="index.html" class="brand"> <img alt="" src="images/logo-black.svg" class="dark-brand"><img alt="" src="images/logo-white.svg" class="light-brand"></a>
				<!-- Menu-->
				<div class="menu"></div>
			</div>
		</header>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="plan item">
									...
									<a href="#" class="btn btn-default">View plan</a>
								</div>
							</div>
							<div class="col-md-4">
		...
		<section>
			<div class="container">
				...
				<div class="grid">
					...
					<a href="pages/portfolio-single.html" class="grid-item"><div style="background-image: url(images/thumbs/07.png)" class="thumb"></div>
						<div class="caption">
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single-2.html" class="grid-item"><div style="background-image: url(images/thumbs/02.png)" class="thumb"></div>
						<div class="caption">
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single.html" class="grid-item tall"><div style="background-image: url(images/thumbs/03.png)" class="thumb"></div>
						<div class="caption">
							<div class="type">Design + Art Direction</div>
							<div class="description">
								<h4>Suit Inc.</h4>
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single-2.html" class="grid-item"><div style="background-image: url(images/thumbs/04.png)" class="thumb"></div>
						<div class="caption">
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single.html" class="grid-item"><div style="background-image: url(images/thumbs/05.png)" class="thumb"></div>
						<div class="caption">
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single-2.html" class="grid-item large"><div style="background-image: url(images/thumbs/06.png)" class="thumb"></div>
						<div class="caption">
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single.html" class="grid-item"><div style="background-image: url(images/portraits/02.jpg)" class="thumb"></div>
						<div class="caption">
							<div class="type">Photography</div>
							<div class="description">
								<h4>She</h4>
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single-2.html" class="grid-item"><div style="background-image: url(images/thumbs/08.png)" class="thumb"></div>
						<div class="caption">
							<div class="type">Design + Art Direction</div>
							<div class="description">
								<h4>Concept</h4>
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single.html" class="grid-item"><div style="background-image: url(images/thumbs/09.png)" class="thumb"></div>
						<div class="caption">
					...
					<!-- Portfolio item-->
					<a href="pages/portfolio-single-2.html" class="grid-item wide"><div style="background-image: url(images/thumbs/10.png)" class="thumb"></div>
						<div class="caption">
		...
		<footer>
			<div class="container content">
				<div class="row">
					...
					<div class="col-md-2">
						<p>
							P (+1) 0 123 456 78<br>F (+1) 0 123 456 78<br>M email@example.com
						</p>
					</div>
					<div class="col-md-2">
						<p>
					...
					<div class="col-md-8 text-right">
						...
						<!-- Copyright message-->
						<div class="copyright">
							2016 &copy; Bone Template. All rights reserved. <a href="http://themeforest.net/item/bone-responsive-agency-portfolio-html-template/15299321">Buy Bone</a>
						</div>
					</div>
				</div>
			</div>
